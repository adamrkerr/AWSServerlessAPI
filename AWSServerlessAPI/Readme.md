...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *AWSServerlessAPI*):
...
Execute unit tests
```
    cd "AWSServerlessAPI/test/AWSServerlessAPI.Tests"
    dotnet test
```
